...
- Vitest covers a small unit/component set (search, command palette, Building). GSAP scroll animations still need a browser.
- Shared UI comes from `@astryxdesign/core` on the public npm registry; no special auth is needed.
