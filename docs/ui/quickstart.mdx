...
<Columns cols={2}>
  <Card title="Theme Provider" href="/ui/theme-provider">
    Mount `N3wthProvider`, load the theme CSS, and toggle modes with `useTheme`.
  </Card>

  <Card title="Primitives" href="/ui/primitives">
    Choose between native Astryx primitives and root compatibility adapters.
  </Card>

  <Card title="Layouts" href="/ui/layouts">
    Build page frames, navigation, headings, sections, and footers.
  </Card>
  ...
  <Card title="OG Images" href="/ui/og-images">
    Generate branded Open Graph images with `OGCard` and `next/og`.
  </Card>
