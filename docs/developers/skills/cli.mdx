---
title: CLI reference and distribution caveats
description: Understand newth-skills commands, local tracking, fallback content, and the limits of its distribution.
---
