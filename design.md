...
Portfolio main section pages open with full-screen abstract line-art stories. Work gathers independent paths into a system; Art creates monumental light forms; Thinking branches; Projects assembles parts; Library layers pages; Contact brings two paths together. The visual direction combines living light sculptures with impossible landscapes: travelling illumination, suspended structures, reflective ground and slow assembly. Choreography runs autonomously; never respond to cursor, hover or scroll position. Share the title scale, left gutter, description width and action placement across all six pages. At desktop widths, vertically center the copy beside artwork confined to the right; use the spacious stacked composition on narrower screens. Keep artwork above and beside readable copy, with no eyebrow text, invented slogans or repeated navigation. Pause motion offscreen for efficiency and show the complete still composition under reduced motion. Keep installation photographs unique in the content below. Article and note reading columns remain centered and use compact headings, with dates beneath the title and description.
