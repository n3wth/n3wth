...
Portfolio section pages share one opening: the same title scale, left gutter, top spacing, description width and action placement. Put visual character in the content that follows: installation photographs used once at generous scale, real interactive project specimens, and distinct career chapters. Do not add slogans, duplicate section navigation or oversized title overlays to make pages feel different. Animated light passages can connect content without changing the opening structure. Keep the title first, with no eyebrow text. Article and note reading columns are centered with equal outer margins; their dates sit below the title and description. Reading pages retain the quieter shared heading scale.
