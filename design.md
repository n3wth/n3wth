...
Portfolio main section pages open with full-screen abstract line-art stories. Work gathers independent paths into a system; Art creates monumental light forms; Thinking branches; Projects assembles parts; Library layers pages; Contact brings two paths together. Share the title scale, left gutter, description width and action placement across all six pages. Keep artwork above and beside readable copy, with no eyebrow text, invented slogans or repeated navigation. Use slow motion, pause it offscreen and show the complete still composition under reduced motion. Keep installation photographs unique in the content below. Article and note reading columns remain centered and use compact headings, with dates beneath the title and description.
