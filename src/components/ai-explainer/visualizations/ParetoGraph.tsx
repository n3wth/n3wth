    ...
    <svg viewBox="0 0 400 280" className="w-full h-auto" style={{ maxHeight: '280px' }}>
      ...
      <defs>
        <pattern id="grid" width="30" height="20" patternUnits="userSpaceOnUse">
          <path d="M 30 0 L 0 0 0 20" fill="none" stroke={colors.grey800} strokeWidth="0.5" />
        </pattern>
      </defs>
      <rect x="50" y="50" width="300" height="200" fill="url(#grid)" opacity="0.5" />

      {/* Axes */}
      <line x1="50" y1="250" x2="350" y2="250" stroke={colors.grey600} strokeWidth="2" />
      <line x1="50" y1="250" x2="50" y2="50" stroke={colors.grey600} strokeWidth="2" />

      {/* Axis labels */}
      <text x="200" y="275" textAnchor="middle" fill={colors.grey400} fontSize="11">
        Engagement
      </text>
      <text
        x="20"
      ...
      <path
        ...
        strokeDasharray="6,4"
      />
      <text x="340" y="65" fill={colors.yellow} fontSize="9" opacity="0.7">
        frontier
      </text>
      ...
      {/* Scale markers */}
      <text x="50" y="265" fill={colors.grey600} fontSize="9">0</text>
      <text x="345" y="265" fill={colors.grey600} fontSize="9">100</text>
      <text x="35" y="255" fill={colors.grey600} fontSize="9">0</text>
      <text x="35" y="55" fill={colors.grey600} fontSize="9">100</text>
    </svg>
  )
})
