    ...
    <>
      <div className="min-w-0">
        ...
        <p
          ...
          style={{ color: 'var(--ink-dim)', maxWidth: '44ch', textWrap: 'balance' }}
        >
...
/* After dark as a walk through a night gallery: section header, then the
   opener work and remaining installations at near-viewport height. Every
   work carries a credit rail under its frame. Every image drifts slowly
   (CSS Ken Burns, reduced-motion safe). */
