...
// Geist Sans + Geist Mono. Values mirror the site's own token system
// (previously sourced from @n3wth/ui/theme) — single source of truth for
// n3wth.com, agents.n3wth.com, garden.n3wth.com.
...
export const n3wthTheme = defineTheme({
  ...
  tokens: {
    // Core semantic — canonical @n3wth/ui palette
