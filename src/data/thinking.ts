...
export const thoughtPieces: ThoughtPiece[] = [
  ...
  },
  {
    ...
    insights: [
      ...
      'Art forces you to work with ambiguity. Most product managers optimize for certainty; the best ones know when to hold space for emergence. That skill transfers directly to early-stage AI product development.',
      'Creative practice rebuilds the muscle for first-principles thinking that gets atrophied by years of best-practice templates and OKR frameworks.',
    ],
    category: 'Creative Tech',
  },
  {
    id: 'research-production-gap',
    title: 'The 1000x gap between demo and deployment',
    description:
      'Every AI research demo works. Getting it to work reliably at 100K QPS with 99.9% uptime, graceful degradation, and a cost structure that doesn\'t bankrupt the business unit is the actual job. After shipping AI products at four companies, the patterns are clear.',
    insights: [
      ...
      'At Covariant, I learned that real-world robotics AI needs to handle 10x more edge cases than the research paper considered. The long tail of warehouse environments is where computer vision systems actually live.',
      'The teams that ship fastest build evaluation infrastructure first. If you can\'t measure regression in under 5 minutes, you can\'t iterate fast enough to survive the transition from research to product.',
    ],
    category: 'AI',
  },
  {
    ...
    description:
      'When your installation needs to survive 60mph dust storms, 110-degree heat, and 70,000 people who have never read a manual, you learn to design for failure in ways that server-room engineering never teaches you. The playa is the best stress test environment on earth.',
    insights: [
      'Every LED controller in a Burning Man installation runs its own state machine. If the network fails, each node falls back to a standalone pattern. This is the same principle behind circuit breakers in microservices, but you learn it faster when the alternative is darkness at 2am.',
      ...
      'The audience doesn\'t care about your architecture -- they care about the experience. This is true for 70,000 people in the desert and 750 million people on Instagram. Ship the feeling, not the spec sheet.',
    ],
    category: 'Design',
  },
]
