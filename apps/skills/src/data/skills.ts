...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    seoTitle: 'Skill Creator: Claude Skill Builder & Agent Skills Template',
    seoDescription: 'Build Claude Code Agent Skills with skill-creator: the Claude skill builder template, triggers, and install steps for Claude Code and Antigravity CLI.',
    category: 'development',
    tags: ['skill-creator', 'claude-skill-builder', 'claude-code', 'agent-skills', 'skill-template', 'skills-md', 'skills-creator-claude'],
    icon: '◈',
