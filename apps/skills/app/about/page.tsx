...
export const metadata: Metadata = {
  ...
  description:
    'Learn what AI coding skills are, how they work with Gemini CLI, and when to use them vs MCP servers for your development workflow.',
  ...
  twitter: {
    ...
    title: 'About AI Skills — What They Are and How They Work',
    description:
      'Learn what AI coding skills are and how they work with Gemini CLI.',
  },
}
  ...
  return (
    <>
      <WebPageJsonLd
        ...
        description="Learn what AI coding skills are, how they work with Gemini CLI, and when to use them vs MCP servers."
        url="https://skills.n3wth.com/about"
        breadcrumbs={[
