...
export const metadata: Metadata = {
  twitter: { images: ['/twitter-image'], card: 'summary_large_image', title: 'Request a Skill', description: "Request a new skill for the skills.n3wth.com directory. Let us know what you'd like to see." },
