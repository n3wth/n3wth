...
export function Footer() {
  return <SiteFooter data-nosnippet signup={<SiteSignup onSubmit={trackSignup} />} links={<>
    ...
    <a href="https://r3.n3wth.com" onClick={() => trackOutbound('https://r3.n3wth.com', 'footer')}>r3</a>
    <a href="https://kit.n3wth.com" onClick={() => trackOutbound('https://kit.n3wth.com', 'footer')}>Kit</a>
