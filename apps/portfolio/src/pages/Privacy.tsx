      ...
      <SiteSection data-reveal className="site-content-gutter mx-auto max-w-3xl">
        ...
        <SiteDocSection title="Elsa assistant SMS">
          <SiteText>
            ...
            <strong style={{ color: 'var(--ink)' }}>+1 (424) 667-2214</strong> (primary) or{' '}
            <strong style={{ color: 'var(--ink)' }}>+1 (415) 360-0751</strong> (alternate), your phone number
            ...
            cross-context behavioral advertising. Messaging providers process SMS for +1 424 667-2214 (main) and +1 415 360-0751 (alternate). Reply STOP to
            opt out. See{' '}
        ...
        <SiteDocSection title="SMS data retention">
          <SiteText>
            Phone numbers and SMS conversation content or metadata related to Elsa (+1 424 667-2214 and +1 415 360-0751)
