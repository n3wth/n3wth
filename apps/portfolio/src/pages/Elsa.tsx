      ...
      <SiteSection data-reveal className="site-content-gutter max-w-3xl">
        <Section title="About Elsa">
          <Prose>
            ...
            <strong style={{ color: 'var(--ink)' }}>+1 (415) 718-0992</strong> (Telnyx, primary)
            and <strong style={{ color: 'var(--ink)' }}>+1 (415) 360-0751</strong> (Twilio, alternate).
          </Prose>
        </Section>
        ...
        <Section title="How to opt in">
          ...
          >
            <p className="text-base leading-relaxed" style={{ color: 'var(--ink)' }}>
              By texting +1 (415) 718-0992 or +1 (415) 360-0751 or otherwise opting in, you agree to receive automated SMS
        ...
        <Section title="How to opt out">
          <BulletList
            items={[
              <>Replying <strong style={{ color: 'var(--ink)' }}>STOP</strong> to any message from +1 (415) 718-0992 or +1 (415) 360-0751</>,
        ...
        <Section title="Contact">
          <Prose>
            ...
            <br />
            Elsa SMS (primary, Telnyx): +1 (415) 718-0992
            <br />
            Elsa SMS (alternate, Twilio): +1 (415) 360-0751
          </Prose>
        </Section>
      </SiteSection>
    </section>
