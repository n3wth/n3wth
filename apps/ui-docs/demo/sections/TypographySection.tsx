...
export function TypographySection() {
  return <DemoSection id="typography" title="Typography" description="Satoshi gives headings their shape. Geist Sans keeps reading and controls clear; Geist Mono is reserved for code.">
    <div className="docs-type-grid">
      <div className="docs-type-specimen">
        <SiteText variant="supporting">Headings · Satoshi</SiteText>
      ...
      <div className="docs-type-specimen">
        <SiteText variant="supporting">Reading and controls · Geist Sans</SiteText>
