...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${siteUrls.kit}/ai/cursorrules`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${siteUrls.kit}/docs/cursor`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/docs/agents`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/docs/v0`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/docs/lovable`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/changelog`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.5 },
    { url: `${siteUrls.kit}/blog/why-ai-tools-generate-ugly-code`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/blog/shadcn-registry-protocol`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/blog/ai-context-packs-explained`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/blog/shadcn-registry-protocol-deep-dive`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrls.kit}/blog/why-every-ai-tool-generates-same-ui`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
