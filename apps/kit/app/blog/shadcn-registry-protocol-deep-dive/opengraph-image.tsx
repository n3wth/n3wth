...
export const alt = 'The shadcn Registry Protocol: A Technical Deep Dive — n3wth/kit'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          How the JSON schema, dependency resolution, and install flow work under the hood
        </div>
        <div
          style={{
            display: 'flex',
